#ifndef MALLARD_TOP_TREE_H
#define MALLARD_TOP_TREE_H 1
...
namespace mld {
// TODO: Should this instead use TreeDP?
...
public:
    constexpr top_tree() noexcept = default;

    template <typename R>
        requires internal::sized_input_range_of<operand, R>
    explicit constexpr top_tree(R &&r) noexcept {
